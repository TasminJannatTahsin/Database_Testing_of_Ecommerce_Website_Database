...
CREATE TABLE `order_items` (
  ...
  CONSTRAINT `chk_order_item_prices` CHECK (((`unit_price` >= 0) and (`discount_amount` >= 0) and (`line_total` >= 0))),
...
INSERT INTO `order_items` VALUES (1,1,1,2,850.00,85.00,1615.00),(2,2,5,1,2200.00,220.00,1980.00),(3,2,4,1,750.00,75.00,675.00),(4,3,6,1,650.00,0.00,650.00);
